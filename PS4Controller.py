...
class PS4Controller(object):
    ...
    def send_joystick_position_update(self):
        ...
        msg = [1, 4, [self.last_axis0_input, -self.last_axis1_input, -self.last_axis3_input]]
    ...
    def process_button_down_event(self, event):
        ...
        if event.button == 0:
            ...
            self.mainQueue.put([1, 5, []])
        elif event.button == 5:
            # Tell arduinoController to toggle LED
            self.mainQueue.put([1, 8, []])
        elif event.button == 6:
            # Tell cameraController to start video feed
            self.mainQueue.put([3, 0, []])
